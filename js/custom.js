...
$(function () {
  ...
  -------------------------------------------------------*/
    $(".header .caption h2 span").typed({
        strings: ["Freelancer", "Photographer", "Web developer","Everything For You"],
        loop: true,
        startDelay: 1000,
        backDelay: 2000,
    });
  ...
  -------------------------------------------------------*/
    $(".testimonial .owl-carousel").owlCarousel({
        ...
        dots: false,
        nav: true,
        navText: ['<span> <i class="jam jam-angle-left"></i> </span>', '<span> <i class="jam jam-angle-right"></i> </span>'],
    });
