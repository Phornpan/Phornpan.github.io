...
!(function (a, b) {
        ...
        n.extend({
            ...
            map: function (a, b, c) {
                var d,
                    ...
                    g = 0,
                    h = [];
                if (s(a)) for (d = a.length; g < d; g++) (e = b(a[g], g, c)), null != e && h.push(e);
            ...
            proxy: function (a, b) {
                var c, d, f;
                if (("string" == typeof b && ((c = a[b]), (b = a), (a = c)), n.isFunction(a)))
                    return (
    ...
    n.extend({
        ...
        clone: function (a, b, c) {
            ...
            if (b)
                if (c) for (f = f || _(a), g = g || _(h), d = 0, e = f.length; d < e; d++) sa(f[d], g[d]);
                else sa(a, h);
